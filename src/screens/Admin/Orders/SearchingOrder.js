...
export default function SearchingOrder({ navigation }) {
  ...
  return (
   ...
   <BtnBackOf onPress={() => navigation.goBack()} />
      ...
      <Text className = "text-center leading-[50px] text-white font-bold text-[18px]">Tìm Đơn</Text>
      </BUTTON>
      <View className="w-5/6 h-4/5 mx-auto">
       <ScrollView className = "w-full h-full">
       <Input title={'Mã Đơn'} isStyle={{color: 'black'}}/>
           {/* Thông tin trả về */}
